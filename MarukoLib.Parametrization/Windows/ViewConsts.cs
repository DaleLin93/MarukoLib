...
namespace MarukoLib.Parametrization.Windows
{
    ...
    public static class ViewConsts
    {
        ...
        public const string SharedResourceDictionaryUri = "pack://application:,,,/MarukoLib.Parametrization;component/Resources/SharedResourceDictionary.xaml";

        public const string AlertImageUri = "pack://application:,,,/MarukoLib.Parametrization;component/Resources/Alert.png";

        public const string MinusGrayImageUri = "pack://application:,,,/MarukoLib.Parametrization;component/Resources/MinusGray.png";

        public const string MinusRedImageUri = "pack://application:,,,/MarukoLib.Parametrization;component/Resources/MinusRed.png";

        public const string ResetImageUri = "pack://application:,,,/MarukoLib.Parametrization;component/Resources/Reset.png";
        ...
        public static readonly Color LightInvalidColor = Color.FromScRgb(1, 1, 0.5F, 0.6F);

        public static readonly Brush InvalidColorBrush = new SolidColorBrush(InvalidColor);

        public static readonly Brush LightInvalidColorBrush = new SolidColorBrush(LightInvalidColor);
