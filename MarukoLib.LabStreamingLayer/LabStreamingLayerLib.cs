...
namespace MarukoLib.LabStreamingLayer
{
    ...
    public class LabStreamingLayerLib
    {

        static LabStreamingLayerLib()
        {
            byte[] libBytes;
            switch (IntPtr.Size)
            {
                ...
                case 4:
#if DEBUG
                    libBytes = Resources.liblsl32_debug;
#else
                libBytes = Resources.liblsl32;
#endif
                    break;
                // 64-bit
                case 8:
#if DEBUG
                    libBytes = Resources.liblsl64_debug;
#else
                libBytes = Resources.liblsl64;
#endif
                    break;
                default:
                    throw new NotSupportedException();
            }
//            File.WriteAllBytes(Interop.libname, libBytes);
        }
        ...
        */
        public static int protocol_version() { return Interop.lsl_protocol_version(); }
        ...
        */
        public static int library_version() { return Interop.lsl_library_version(); }
        ...
        */
        public static double local_clock() { return Interop.lsl_local_clock(); }
        ...
        */
        ...
        public class StreamInfo
        {
            ...
            */
            public StreamInfo(string name, string type) { obj = Interop.lsl_create_streaminfo(name, type, 1, IRREGULAR_RATE, channel_format_t.cf_float32, ""); }
            public StreamInfo(string name, string type, int channel_count) { obj = Interop.lsl_create_streaminfo(name, type, channel_count, IRREGULAR_RATE, channel_format_t.cf_float32, ""); }
            public StreamInfo(string name, string type, int channel_count, double nominal_srate) { obj = Interop.lsl_create_streaminfo(name, type, channel_count, nominal_srate, channel_format_t.cf_float32, ""); }
            public StreamInfo(string name, string type, int channel_count, double nominal_srate, channel_format_t channel_format) { obj = Interop.lsl_create_streaminfo(name, type, channel_count, nominal_srate, channel_format, ""); }
            public StreamInfo(string name, string type, int channel_count, double nominal_srate, channel_format_t channel_format, string source_id) { obj = Interop.lsl_create_streaminfo(name, type, channel_count, nominal_srate, channel_format, source_id); }
            public StreamInfo(IntPtr handle) { obj = handle; }

            /// Destroy a previously created streaminfo object.
            ~StreamInfo() { Interop.lsl_destroy_streaminfo(obj); }
            ...
            */
            public string name() { return Marshal.PtrToStringAnsi(Interop.lsl_get_name(obj)); }
            ...
            */
            public string type() { return Marshal.PtrToStringAnsi(Interop.lsl_get_type(obj)); }

            /**
            * Number of channels of the stream.
            * A stream has at least one channel; the channel count stays constant for all samples.
            */
            public int channel_count() { return Interop.lsl_get_channel_count(obj); }
            ...
            */
            public double nominal_srate() { return Interop.lsl_get_nominal_srate(obj); }
            ...
            */
            public channel_format_t channel_format() { return Interop.lsl_get_channel_format(obj); }
            ...
            */
            public string source_id() { return Marshal.PtrToStringAnsi(Interop.lsl_get_source_id(obj)); }
            ...
            */
            public int version() { return Interop.lsl_get_version(obj); }
            ...
            */
            public double created_at() { return Interop.lsl_get_created_at(obj); }
            ...
            */
            public string uid() { return Marshal.PtrToStringAnsi(Interop.lsl_get_uid(obj)); }
            ...
            */
            public string session_id() { return Marshal.PtrToStringAnsi(Interop.lsl_get_session_id(obj)); }

            /**
            * Hostname of the providing machine.
            */
            public string hostname() { return Marshal.PtrToStringAnsi(Interop.lsl_get_hostname(obj)); }
            ...
            */
            public XMLElement desc() { return new XMLElement(Interop.lsl_get_desc(obj)); }
        ...
        */
        public class StreamOutlet
        {
            ...
            */
            public StreamOutlet(StreamInfo info) { obj = Interop.lsl_create_outlet(info.handle(), 0, 360); }
            public StreamOutlet(StreamInfo info, int chunk_size) { obj = Interop.lsl_create_outlet(info.handle(), chunk_size, 360); }
            public StreamOutlet(StreamInfo info, int chunk_size, int max_buffered) { obj = Interop.lsl_create_outlet(info.handle(), chunk_size, max_buffered); }

            /**
            * Destructor.
            * The stream will no longer be discoverable after destruction and all paired inlets will stop delivering data.
            */
            ~StreamOutlet() { Interop.lsl_destroy_outlet(obj); }
            ...
            */
            public void push_sample(float[] data) { Interop.lsl_push_sample_ftp(obj, data, 0.0, 1); }
            public void push_sample(float[] data, double timestamp) { Interop.lsl_push_sample_ftp(obj, data, timestamp, 1); }
            public void push_sample(float[] data, double timestamp, bool pushthrough) { Interop.lsl_push_sample_ftp(obj, data, timestamp, pushthrough ? 1 : 0); }
            public void push_sample(double[] data) { Interop.lsl_push_sample_dtp(obj, data, 0.0, 1); }
            public void push_sample(double[] data, double timestamp) { Interop.lsl_push_sample_dtp(obj, data, timestamp, 1); }
            public void push_sample(double[] data, double timestamp, bool pushthrough) { Interop.lsl_push_sample_dtp(obj, data, timestamp, pushthrough ? 1 : 0); }
            public void push_sample(int[] data) { Interop.lsl_push_sample_itp(obj, data, 0.0, 1); }
            public void push_sample(int[] data, double timestamp) { Interop.lsl_push_sample_itp(obj, data, timestamp, 1); }
            public void push_sample(int[] data, double timestamp, bool pushthrough) { Interop.lsl_push_sample_itp(obj, data, timestamp, pushthrough ? 1 : 0); }
            public void push_sample(short[] data) { Interop.lsl_push_sample_stp(obj, data, 0.0, 1); }
            public void push_sample(short[] data, double timestamp) { Interop.lsl_push_sample_stp(obj, data, timestamp, 1); }
            public void push_sample(short[] data, double timestamp, bool pushthrough) { Interop.lsl_push_sample_stp(obj, data, timestamp, pushthrough ? 1 : 0); }
            public void push_sample(char[] data) { Interop.lsl_push_sample_ctp(obj, data, 0.0, 1); }
            public void push_sample(char[] data, double timestamp) { Interop.lsl_push_sample_ctp(obj, data, timestamp, 1); }
            public void push_sample(char[] data, double timestamp, bool pushthrough) { Interop.lsl_push_sample_ctp(obj, data, timestamp, pushthrough ? 1 : 0); }
            public void push_sample(string[] data) { Interop.lsl_push_sample_strtp(obj, data, 0.0, 1); }
            public void push_sample(string[] data, double timestamp) { Interop.lsl_push_sample_strtp(obj, data, timestamp, 1); }
            public void push_sample(string[] data, double timestamp, bool pushthrough) { Interop.lsl_push_sample_strtp(obj, data, timestamp, pushthrough ? 1 : 0); }
            ...
            *                    Note that the chunk_size, if specified at outlet construction, takes precedence over the pushthrough flag.
            */
            public void push_chunk(float[,] data) { Interop.lsl_push_chunk_ftp(obj, data, (uint)data.Length, 0.0, 1); }
            public void push_chunk(float[,] data, double timestamp) { Interop.lsl_push_chunk_ftp(obj, data, (uint)data.Length, timestamp, 1); }
            public void push_chunk(float[,] data, double timestamp, bool pushthrough) { Interop.lsl_push_chunk_ftp(obj, data, (uint)data.Length, timestamp, pushthrough ? 1 : 0); }
            public void push_chunk(double[,] data) { Interop.lsl_push_chunk_dtp(obj, data, (uint)data.Length, 0.0, 1); }
            public void push_chunk(double[,] data, double timestamp) { Interop.lsl_push_chunk_dtp(obj, data, (uint)data.Length, timestamp, 1); }
            public void push_chunk(double[,] data, double timestamp, bool pushthrough) { Interop.lsl_push_chunk_dtp(obj, data, (uint)data.Length, timestamp, pushthrough ? 1 : 0); }
            public void push_chunk(int[,] data) { Interop.lsl_push_chunk_itp(obj, data, (uint)data.Length, 0.0, 1); }
            public void push_chunk(int[,] data, double timestamp) { Interop.lsl_push_chunk_itp(obj, data, (uint)data.Length, timestamp, 1); }
            public void push_chunk(int[,] data, double timestamp, bool pushthrough) { Interop.lsl_push_chunk_itp(obj, data, (uint)data.Length, timestamp, pushthrough ? 1 : 0); }
            public void push_chunk(short[,] data) { Interop.lsl_push_chunk_stp(obj, data, (uint)data.Length, 0.0, 1); }
            public void push_chunk(short[,] data, double timestamp) { Interop.lsl_push_chunk_stp(obj, data, (uint)data.Length, timestamp, 1); }
            public void push_chunk(short[,] data, double timestamp, bool pushthrough) { Interop.lsl_push_chunk_stp(obj, data, (uint)data.Length, timestamp, pushthrough ? 1 : 0); }
            public void push_chunk(char[,] data) { Interop.lsl_push_chunk_ctp(obj, data, (uint)data.Length, 0.0, 1); }
            public void push_chunk(char[,] data, double timestamp) { Interop.lsl_push_chunk_ctp(obj, data, (uint)data.Length, timestamp, 1); }
            public void push_chunk(char[,] data, double timestamp, bool pushthrough) { Interop.lsl_push_chunk_ctp(obj, data, (uint)data.Length, timestamp, pushthrough ? 1 : 0); }
            public void push_chunk(string[,] data) { Interop.lsl_push_chunk_strtp(obj, data, (uint)data.Length, 0.0, 1); }
            public void push_chunk(string[,] data, double timestamp) { Interop.lsl_push_chunk_strtp(obj, data, (uint)data.Length, timestamp, 1); }
            public void push_chunk(string[,] data, double timestamp, bool pushthrough) { Interop.lsl_push_chunk_strtp(obj, data, (uint)data.Length, timestamp, pushthrough ? 1 : 0); }
            ...
            *                    Note that the chunk_size, if specified at outlet construction, takes precedence over the pushthrough flag.
            */
            public void push_chunk(float[,] data, double[] timestamps) { Interop.lsl_push_chunk_ftnp(obj, data, (uint)data.Length, timestamps, 1); }
            public void push_chunk(float[,] data, double[] timestamps, bool pushthrough) { Interop.lsl_push_chunk_ftnp(obj, data, (uint)data.Length, timestamps, pushthrough ? 1 : 0); }
            public void push_chunk(double[,] data, double[] timestamps) { Interop.lsl_push_chunk_dtnp(obj, data, (uint)data.Length, timestamps, 1); }
            public void push_chunk(double[,] data, double[] timestamps, bool pushthrough) { Interop.lsl_push_chunk_dtnp(obj, data, (uint)data.Length, timestamps, pushthrough ? 1 : 0); }
            public void push_chunk(int[,] data, double[] timestamps) { Interop.lsl_push_chunk_itnp(obj, data, (uint)data.Length, timestamps, 1); }
            public void push_chunk(int[,] data, double[] timestamps, bool pushthrough) { Interop.lsl_push_chunk_itnp(obj, data, (uint)data.Length, timestamps, pushthrough ? 1 : 0); }
            public void push_chunk(short[,] data, double[] timestamps) { Interop.lsl_push_chunk_stnp(obj, data, (uint)data.Length, timestamps, 1); }
            public void push_chunk(short[,] data, double[] timestamps, bool pushthrough) { Interop.lsl_push_chunk_stnp(obj, data, (uint)data.Length, timestamps, pushthrough ? 1 : 0); }
            public void push_chunk(char[,] data, double[] timestamps) { Interop.lsl_push_chunk_ctnp(obj, data, (uint)data.Length, timestamps, 1); }
            public void push_chunk(char[,] data, double[] timestamps, bool pushthrough) { Interop.lsl_push_chunk_ctnp(obj, data, (uint)data.Length, timestamps, pushthrough ? 1 : 0); }
            public void push_chunk(string[,] data, double[] timestamps) { Interop.lsl_push_chunk_strtnp(obj, data, (uint)data.Length, timestamps, 1); }
            public void push_chunk(string[,] data, double[] timestamps, bool pushthrough) { Interop.lsl_push_chunk_strtnp(obj, data, (uint)data.Length, timestamps, pushthrough ? 1 : 0); }
            ...
            */
            public bool have_consumers() { return Interop.lsl_have_consumers(obj) > 0; }

            /**
            * Wait until some consumer shows up (without wasting resources).
            * @return True if the wait was successful, false if the timeout expired.
            */
            public bool wait_for_consumers(double timeout) { return Interop.lsl_wait_for_consumers(obj) > 0; }
            ...
            */
            public StreamInfo info() { return new StreamInfo(Interop.lsl_get_info(obj)); }
        ...
        */
        public class StreamInlet
        {
            /**
                    ...
                    */
            public StreamInlet(StreamInfo info) { obj = Interop.lsl_create_inlet(info.handle(), 360, 0, 1); }
            public StreamInlet(StreamInfo info, int max_buflen) { obj = Interop.lsl_create_inlet(info.handle(), max_buflen, 0, 1); }
            public StreamInlet(StreamInfo info, int max_buflen, int max_chunklen) { obj = Interop.lsl_create_inlet(info.handle(), max_buflen, max_chunklen, 1); }
            public StreamInlet(StreamInfo info, int max_buflen, int max_chunklen, bool recover) { obj = Interop.lsl_create_inlet(info.handle(), max_buflen, max_chunklen, recover ? 1 : 0); }

            /** 
            * Destructor.
            * The inlet will automatically disconnect if destroyed.
            */
            ~StreamInlet() { Interop.lsl_destroy_inlet(obj); }
            ...
            * resources.
            */
            public void close_stream() { Interop.lsl_close_stream(obj); }
            ...
            */
            public int samples_available() { return (int)Interop.lsl_samples_available(obj); }
            ...
            */
            public bool was_clock_reset() { return (int)Interop.lsl_was_clock_reset(obj) != 0; }
        ...
        */
        public struct XMLElement
        {
            ...
            public XMLElement first_child() { return new XMLElement(Interop.lsl_first_child(obj)); }

            /// Get the last child of the element.
            public XMLElement last_child() { return new XMLElement(Interop.lsl_last_child(obj)); }

            /// Get the next sibling in the children list of the parent node.
            public XMLElement next_sibling() { return new XMLElement(Interop.lsl_next_sibling(obj)); }

            /// Get the previous sibling in the children list of the parent node.
            public XMLElement previous_sibling() { return new XMLElement(Interop.lsl_previous_sibling(obj)); }

            /// Get the parent node.
            public XMLElement parent() { return new XMLElement(Interop.lsl_parent(obj)); }


            // === Tree Navigation by Name ===

            /// Get a child with a specified name.
            public XMLElement child(string name) { return new XMLElement(Interop.lsl_child(obj, name)); }

            /// Get the next sibling with the specified name.
            public XMLElement next_sibling(string name) { return new XMLElement(Interop.lsl_next_sibling_n(obj, name)); }

            /// Get the previous sibling with the specified name.
            public XMLElement previous_sibling(string name) { return new XMLElement(Interop.lsl_previous_sibling_n(obj, name)); }


            // === Content Queries ===

            /// Whether this node is empty.
            public bool empty() { return Interop.lsl_empty(obj) != 0; }

            /// Whether this is a text body (instead of an XML element). True both for plain char data and CData.
            public bool is_text() { return Interop.lsl_is_text(obj) != 0; }

            /// Name of the element.
            public string name() { return Marshal.PtrToStringAnsi(Interop.lsl_name(obj)); }

            /// Value of the element.
            public string value() { return Marshal.PtrToStringAnsi(Interop.lsl_value(obj)); }

            /// Get child value (value of the first child that is text).
            public string child_value() { return Marshal.PtrToStringAnsi(Interop.lsl_child_value(obj)); }

            /// Get child value of a child with a specified name.
            public string child_value(string name) { return Marshal.PtrToStringAnsi(Interop.lsl_child_value_n(obj, name)); }
            ...
            */
            public XMLElement append_child_value(string name, string value) { return new XMLElement(Interop.lsl_append_child_value(obj, name, value)); }

            /**
            * Prepend a child node with a given name, which has a (nameless) plain-text child with the given text value.
            */
            public XMLElement prepend_child_value(string name, string value) { return new XMLElement(Interop.lsl_prepend_child_value(obj, name, value)); }

            /**
            * Set the text value of the (nameless) plain-text child of a named child node.
            */
            public bool set_child_value(string name, string value) { return Interop.lsl_set_child_value(obj, name, value) != 0; }

            /**
            * Set the element's name.
            * @return False if the node is empty.
            */
            public bool set_name(string rhs) { return Interop.lsl_set_name(obj, rhs) != 0; }

            /**
            * Set the element's value.
            * @return False if the node is empty.
            */
            public bool set_value(string rhs) { return Interop.lsl_set_value(obj, rhs) != 0; }

            /// Append a child element with the specified name.
            public XMLElement append_child(string name) { return new XMLElement(Interop.lsl_append_child(obj, name)); }

            /// Prepend a child element with the specified name.
            public XMLElement prepend_child(string name) { return new XMLElement(Interop.lsl_prepend_child(obj, name)); }

            /// Append a copy of the specified element as a child.
            public XMLElement append_copy(XMLElement e) { return new XMLElement(Interop.lsl_append_copy(obj, e.obj)); }

            /// Prepend a child element with the specified name.
            public XMLElement prepend_copy(XMLElement e) { return new XMLElement(Interop.lsl_prepend_copy(obj, e.obj)); }

            /// Remove a child element with the specified name.
            public void remove_child(string name) { Interop.lsl_remove_child_n(obj, name); }

            /// Remove a specified child element.
            public void remove_child(XMLElement e) { Interop.lsl_remove_child(obj, e.obj); }
        ...
        */
        ...
        public class ContinuousResolver
        {
            ...
            */
            public ContinuousResolver() { obj = Interop.lsl_create_continuous_resolver(5.0); }
            public ContinuousResolver(double forget_after) { obj = Interop.lsl_create_continuous_resolver(forget_after); }
            ...
            *                     this is the time in seconds after which it is no longer reported by the resolver.
            */
            public ContinuousResolver(string prop, string value) { obj = Interop.lsl_create_continuous_resolver_byprop(prop, value, 5.0); }
            public ContinuousResolver(string prop, string value, double forget_after) { obj = Interop.lsl_create_continuous_resolver_byprop(prop, value, forget_after); }
            ...
            *                     this is the time in seconds after which it is no longer reported by the resolver.
            */
            public ContinuousResolver(string pred) { obj = Interop.lsl_create_continuous_resolver_bypred(pred, 5.0); }
            public ContinuousResolver(string pred, double forget_after) { obj = Interop.lsl_create_continuous_resolver_bypred(pred, forget_after); }

            /** 
            * Destructor.
            */
            ~ContinuousResolver() { Interop.lsl_destroy_continuous_resolver(obj); }
        ...
        internal static class Interop
        {
            ...
            public const string libname = "liblsl32.dll";
